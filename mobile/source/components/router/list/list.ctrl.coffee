...
do (_, angular) ->
    ...
    angular.module('controller').controller 'ListCtrl',
        ...
        _.ai '            @api, @user, @$scope, @$rootScope, @$window, @map_loan_summary, @map_assignment_summary, @$routeParams', class
            constructor: (@api, @user, @$scope, @$rootScope, @$window, @map_loan_summary, @map_assignment_summary, @$routeParams) ->
            ...
            query: (query_set, options = {}) ->
                ...
                if @$scope.current_tab in _.split 'loan'
