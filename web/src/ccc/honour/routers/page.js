...
module.exports = function (router) {
    router.get('/', async function (req, res) {
        ...
        res.locals.title = '尊享理财-固定收益-定期理财-汇财富';
        res.locals.keywords = '高端理财，高收益理财产品，定期，汇鑫理财';
        res.locals.description = '尊享理财专注于固定收益理财产品，包括世界500强，优质上市公司和信用评级AA+以上等优质资产，帮助投资投者获得低风险的稳定收益。';
    ...
    router.get('/list/:key', function (req, res, next) {
        if (req.params.key == 'ZXLC') {
            res.expose('ZXLC', 'key');
            res.locals.key = 'ZXLC';
            res.locals.title = '尊享理财-固定收益-定期理财-汇财富';
            res.locals.keywords = '尊享理财，高收益理财产品，定期，汇鑫理财';
            res.locals.description = '尊享理财专注于固定收益理财产品，包括世界500强，优质上市公司和信用评级AA+以上等优质资产，帮助投资投者获得低风险的稳定收益。';
        }
        res.render('list');
    });
