...
var InvestListService = require('ccc/honour/js/main/service/list').InvestListService;
...
if (!CC.key) {
    var listRactive = new Ractive({
        el: ".fixedPro",
        template: require('ccc/honour/partials/fixedPro.html'),
        oncomplete: function () {
            var that = this;
            params.pageSize = 5;
            params.product = 'ZXLC';
    ...
    var investRactive = new Ractive({
        el: ".list_box",
        template: require('ccc/honour/partials/list.html'),
        data: {
            list: [],
        ...
        renderPager: function (res, currentPage, obj) {
            ...
            var pagerRactive = new Ractive({
                el: '#invest-pager',
                template: require('ccc/honour/partials/pager.html'),
                data: {
