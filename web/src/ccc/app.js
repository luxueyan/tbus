...
app.use(async function (req, res, next) {
    res.locals.title = '土巴士-土巴士资本旗下互联网金融资产交易服务平台';
    res.locals.keywords = '土巴士,互联网金融,投资理财,财富管理,理财产品';
    res.locals.description = '土巴士是由土巴士资本倾力打造的互联网金融资产交易服务平台，专门为白领、中产精英等高潜力人群提供专业、可信赖的投资理财，财富管理服务，实现财富增值。土巴士由原深发展总行行长、平安银行原董事长肖遂宁领衔打造，专注于世界500强，优质上市公司和信用评级AA+以上等优质资产，从源头上保证资产安全。投资理财用户在土巴士官网或APP可通过理财产品、高端理财、债权转让等方式进行投资获得稳定收益。';
